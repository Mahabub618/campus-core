...
CREATE UNIQUE INDEX IF NOT EXISTS idx_parents_user_id ON parents(user_id);
...
CREATE INDEX IF NOT EXISTS idx_parent_student_relations_deleted_at ON parent_student_relations(deleted_at);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_accountants_user_id ON accountants(user_id);
CREATE INDEX IF NOT EXISTS idx_accountants_institution_id ON accountants(institution_id);
CREATE INDEX IF NOT EXISTS idx_accountants_deleted_at ON accountants(deleted_at);
